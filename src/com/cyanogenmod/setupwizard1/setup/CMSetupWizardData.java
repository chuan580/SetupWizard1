...
private  static final String STUDENT = "com.digdou.Student.StartSetting";
    private boolean mTimeSet = false;
    private boolean mTimeZoneSet = false;
    private boolean mMobileDataEnabled;
    
    private final String BR_STUDENT_NO_LOGIN = "com.ifdoo.control.push.UserLoginProvider.NotLogged";
    private final String BR_STUDENT_LOGIN = "com.ifdoo.control.push.UserLoginProvider.Logged";

    Handler handler;
    public CMSetupWizardData(Context context, Handler handler) {
...
//        }
        ...
        /*SetupStats.addEvent(SetupStats.Categories.SETTING_CHANGED,
                    ...
                    String.valueOf(privacyData.getBoolean("enable_nav_keys")));*/
...
//        }
    ...
    public void onReceive(Context context, Intent intent) {
    	if (intent.getAction().equals(BR_STUDENT_NO_LOGIN)) { // 未登录成功
    		System.out.println("nologin-----");
    		onPreviousPage();
    	}
    	if (intent.getAction().equals(BR_STUDENT_LOGIN)) { // 已经登录成功
...
//    		mg.obj = mCurrentPageIndex;
    ...
    public IntentFilter getIntentFilter() {
        ...
        filter.addAction(BR_STUDENT_NO_LOGIN); // 学生端如果没有正常登陆成功，返回上一个页面
        filter.addAction(BR_STUDENT_LOGIN); // 学生端如果登陆成功，禁止开机向导返回
